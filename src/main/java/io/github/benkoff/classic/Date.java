package classic; /******************************************************************************
 *  Compilation:  javac classic.Date.java
 *  Execution:    java classic.Date
...
/**
 *  The {@code classic.Date} class is an immutable data type to encapsulate a
...
public class Date implements Comparable<Date> {
   ...
   /**
    ...
    /**
     * Unit tests the {@code classic.Date} data type.
     *
