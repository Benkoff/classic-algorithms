package classic; /******************************************************************************
 *  Compilation:  javac classic.Stopwatch.java
 *  Execution:    java classic.Stopwatch n
 *  Dependencies: none
 *
 *  A utility class to measure the running time (wall clock) of a program.
 *
 *  % java8 classic.Stopwatch 100000000
...
/**
 *  The {@code classic.Stopwatch} data type is for measuring
...
public class Stopwatch { 
    ...
    /**
     * Unit tests the {@code classic.Stopwatch} data type.
