package classic; /******************************************************************************
 *  Compilation:  javac classic.Interval2D.java
 *  Execution:    java classic.Interval2D
 *  Dependencies: System.out.java classic.Interval1D.java StdDraw.java
 *  
...
/**
 *  The {@code classic.Interval2D} class represents a closed two-dimensional interval,
 ...
 *  The class {@code classic.Interval2D} includes methods for checking whether
...
public class Interval2D {
    ...
    /**
     * Unit tests the {@code classic.Interval2D} data type.
     *
