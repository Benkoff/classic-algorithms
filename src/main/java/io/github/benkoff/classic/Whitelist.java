package classic; /******************************************************************************
 *  Compilation:  javac classic.Whitelist.java
 *  Execution:    java classic.Whitelist whitelist.txt < data.txt
 *  Dependencies: StaticSetOfInts.java In.java System.out.java
 *
 ...
 *
 *  classic.Whitelist filter.
 *
 *
 *  % java classic.Whitelist tinyW.txt < tinyT.txt
 *  50
 *  99
 *  13
 *
 *  % java classic.Whitelist largeW.txt < largeT.txt | more
 *  499569
 *  984875
 *  295754
 *  207807
...
/**
 *  The {@code classic.Whitelist} class provides a client for reading in
