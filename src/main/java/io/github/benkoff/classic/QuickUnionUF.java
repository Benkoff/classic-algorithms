package classic; /******************************************************************************
 *  Compilation:  javac classic.QuickUnionUF.java
 *  Execution:  java classic.QuickUnionUF < input.txt
...
/**
 *  The {@code classic.QuickUnionUF} class represents a <em>union–find data type</em>
