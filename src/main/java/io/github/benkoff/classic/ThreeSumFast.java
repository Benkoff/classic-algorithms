package classic; /******************************************************************************
 *  Compilation:  javac classic.ThreeSumFast.java
 *  Execution:    java classic.ThreeSumFast input.txt
 *  Dependencies: System.out.java In.java classic.Stopwatch.java
 ...
 *
 *
 *  % java classic.ThreeSumFast 1Kints.txt
 *  70
 *  
 *  % java classic.ThreeSumFast 2Kints.txt
 *  528
 *                
 *  % java classic.ThreeSumFast 4Kints.txt
 *  4039
 * 
 *  % java classic.ThreeSumFast 8Kints.txt
 *  32074
 *
 *  % java classic.ThreeSumFast 16Kints.txt
 *  255181
 *
 *  % java classic.ThreeSumFast 32Kints.txt
 *  2052358
 *
 ******************************************************************************/
...
/**
 *  The {@code classic.ThreeSumFast} class provides static methods for counting
