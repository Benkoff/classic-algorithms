package classic; /******************************************************************************
 *  Compilation:  javac classic.QuickFindUF.java
 *  Execution:  java classic.QuickFindUF < input.txt
...
/**
 *  The {@code classic.QuickFindUF} class represents a <em>union–find data type</em>
