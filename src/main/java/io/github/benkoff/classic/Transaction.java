package classic; /******************************************************************************
 *  Compilation:  javac classic.Transaction.java
 *  Execution:    java classic.Transaction
...
/**
 *  The {@code classic.Transaction} class is an immutable data type to encapsulate a
...
public class Transaction implements Comparable<Transaction> {
    ...
    /**
     * Unit tests the {@code classic.Transaction} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        a[2] = new Transaction("classic.Knuth    6/14/1999  288.34");
