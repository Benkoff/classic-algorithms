package classic; /******************************************************************************
 *  Compilation:  javac classic.Vector.java
 *  Execution:    java classic.Vector
 *  Dependencies: System.out.java
 *
 *  Implementation of a vector of real numbers.
 *
 *  This class is implemented to be immutable: once the client program
 *  initialize a classic.Vector, it cannot change any of its fields
 ...
 * 
 *
 *  Note that classic.Vector is also the name of an unrelated Java library class
 *  in the package java.util.
 *
 ******************************************************************************/

/**
 *  The {@code classic.Vector} class represents a <em>d</em>-dimensional Euclidean vector.
...
public class Vector { 
     ...
     * arugments such as classic.Vector x = new classic.Vector(1.0, 2.0, 3.0, 4.0).
     *
    ...
    /**
     * Unit tests the {@code classic.Vector} data type.
     *
