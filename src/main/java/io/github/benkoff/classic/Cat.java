package classic; /******************************************************************************
 *  Compilation:  javac classic.Cat.java
 *  Execution:    java classic.Cat input0.txt input1.txt ... output.txt
 ...
 *  test.
 * 
 *  % java classic.Cat in1.txt in2.txt out.txt
 *
 *  % more out.txt
 *  This is
 *  a tiny
...
/**
 *  The {@code classic.Cat} class provides a client for concatenating the results
