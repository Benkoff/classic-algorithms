package classic; /******************************************************************************
 *  Compilation:  javac classic.Interval1D.java
 *  Execution:    java classic.Interval1D
...
/**
 *  The {@code classic.Interval1D} class represents a one-dimensional interval.
 *  The interval is <em>closed</em>—it contains both endpoints.
 *  Intervals are immutable: their values cannot be changed after they are created.
 *  The class {@code classic.Interval1D} includes methods for checking whether
...
public class Interval1D {
    ...
    /**
     * Unit tests the {@code classic.Interval1D} data type.
     *
