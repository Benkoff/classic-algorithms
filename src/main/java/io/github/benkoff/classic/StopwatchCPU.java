package classic; /******************************************************************************
 *  Compilation:  javac classic.StopwatchCPU.java
 *  Execution:    java StopwtachCPU n
 *  Dependencies: none
 *
 *  A version of classic.Stopwatch.java that measures CPU time on a single
 *  core or processor (instead of wall clock time).
 *
 *  % java8 classic.StopwatchCPU 100000000
...
/**
 *  The {@code classic.StopwatchCPU} data type is for measuring
...
public class StopwatchCPU {
    ...
    /**
     * Unit tests the {@code classic.StopwatchCPU} data type.
