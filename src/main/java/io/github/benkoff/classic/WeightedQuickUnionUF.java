package classic; /******************************************************************************
 *  Compilation:  javac classic.WeightedQuickUnionUF.java
 *  Execution:  java classic.WeightedQuickUnionUF < input.txt
...
/**
 *  The {@code classic.WeightedQuickUnionUF} class represents a <em>union–find data type</em>
