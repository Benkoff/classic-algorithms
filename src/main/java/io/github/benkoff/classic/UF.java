package classic; /******************************************************************************
 *  Compilation:  javac classic.UF.java
 *  Execution:    java classic.UF < input.txt
...
/**
 *  The {@code classic.UF} class represents a <em>union–find data type</em>
