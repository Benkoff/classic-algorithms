package classic; /******************************************************************************
 *  Compilation:  javac classic.LinkedBag.java
 *  Execution:    java classic.LinkedBag < input.txt
 ...
 *
 *  % java classic.LinkedBag < tobe.txt
 *  size of bag = 14
 *  is
 *  -
 *  -
...
/**
 *  The {@code classic.LinkedBag} class represents a bag (or multiset) of 
...
public class LinkedBag<Item> implements Iterable<Item> {
    ...
    /**
     * Unit tests the {@code classic.LinkedBag} data type.
     *
